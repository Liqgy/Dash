...
c = dict(zip(df["country"].unique(), pl.colors.qualitative.G10))
...
def update_graph(country_chosen):
    ...
    #print(dff)
    fig = pl.line(data_frame=dff, x='year', y='gdpPercap', color='country',  hover_data=["lifeExp", "pop", "iso_alpha"]
